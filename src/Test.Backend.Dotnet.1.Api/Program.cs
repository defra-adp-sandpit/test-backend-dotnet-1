...
using Test.Backend.Dotnet.1.Api.AutoMapper;
using Test.Backend.Dotnet.1.Api.Config;
using Test.Backend.Dotnet.1.Api.Extensions;
using Test.Backend.Dotnet.1.Api.HealthChecks;
...
namespace Test.Backend.Dotnet.1.Api;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Test.Backend.Dotnet.1", Version = "v1" });
        });
